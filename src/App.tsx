...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 antialiased selection:bg-[#115E59]/10 leading-normal select-none">
      ...
      <AnimatePresence>
        {checkoutStep !== null && (
          ...
          >
            ...
            >
              {/* Header block */}
              <div className="bg-[#0F4C48] p-6 text-white flex flex-col items-center justify-center text-center relative">
                <button
                ...
                <div className="p-3 bg-[#14B8A6] text-white rounded-2xl mb-3 shadow-md">
                  <ShieldCheck className="h-6 w-6 animate-pulse" />
                </div>
                <h3 className="font-serif text-xl sm:text-2xl font-bold tracking-tight">Direct Sea Sourced Checkout</h3>
                <p className="text-xs text-teal-200 mt-1 font-sans">Step {checkoutStep === 'shipping' ? '1 of 2: Delivery information' : checkoutStep === 'payment' ? '2 of 2: Cold Gateway pay' : 'Complete! order trace active'}</p>
              </div>
                ...
                <div className="p-6 sm:p-8 space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 border border-gray-200 focus:outline-[#115E59] rounded-xl text-xs bg-gray-50/50"
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="600004"
                        className="w-full px-3.5 py-2.5 border border-gray-200 focus:outline-[#115E59] rounded-xl text-xs bg-gray-50/50 text-slate-800 font-bold"
                      />
                    </div>
                    <div>
                  ...
                  <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-6 py-3 bg-[#115E59] hover:bg-[#0D9488] text-white rounded-xl text-xs uppercase tracking-widest font-bold shadow-md cursor-pointer flex items-center gap-1.5"
                    >
                ...
                <div className="p-6 sm:p-8 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-4 border border-gray-200/80 bg-slate-50 rounded-2xl flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <input type="radio" defaultChecked className="accent-[#115E59]" id="pay-cod-radio" />
                        <div>
                  ...
                  <div className="pt-4 border-t border-slate-100 flex items-center justify-between gap-4">
                    ...
                    <button
                      ...
                      className="px-6 py-3 bg-[#0F4C48] hover:bg-black text-white rounded-xl text-xs uppercase tracking-widest font-bold shadow-md cursor-pointer flex items-center gap-1.5"
                    >
              ...
              {checkoutStep === 'completed' && (
                <div className="p-6 sm:p-8 text-center space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-teal-600 font-bold block font-mono uppercase mt-1 tracking-widest">Order ID: K2K-{Math.floor(Math.random() * 89999 + 10000)}</p>
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      onClick={() => setCheckoutStep(null)}
                      className="w-full bg-[#115E59] hover:bg-[#0D9488] text-white text-xs font-bold tracking-widest uppercase py-3.5 rounded-xl cursor-pointer shadow-sm hover:shadow-teal-100 transition-all flex items-center justify-center gap-1.5"
                    >
