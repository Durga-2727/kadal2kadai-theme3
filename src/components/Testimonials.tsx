    ...
    <section id="reviews" className="py-12 sm:py-16 bg-white relative overflow-hidden select-none">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-12">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-teal-50 border border-teal-100 rounded-full mb-3 text-[10px] sm:text-xs uppercase font-bold text-[#115E59] tracking-wider font-mono">
            <MessageSquare className="h-4 w-4 text-[#115E59]" />
        ...
        <div className="space-y-6 pause-marquee relative w-full overflow-hidden px-4 sm:px-0">
          ...
          <div className="animate-marquee-left flex gap-6 py-2">
            {doubleTestimonials.map((item, idx) => (
              ...
              >
                <Quote className="h-6 w-6 text-[#115E59]/10 absolute top-4 right-4" />
