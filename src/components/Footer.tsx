...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-[#64748B] to-[#01012B] text-white overflow-hidden border-t-2 border-[#E9D5FF]/20">
      
      {/* Dynamic Ambient Sea Waterglow Background elements */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#64748B]/15 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#64748B]/30 rounded-full blur-3xl pointer-events-none" />
      
      {/* Symmetrical Top Wave Line SVG Divider */}
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#E9D5FF]/40 to-transparent" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 relative z-10">
        
        {/* Main Columns Grid Layout */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10 pb-16 border-b border-slate-950/50">
          ...
          <div className="space-y-6 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p className="text-[13px] text-slate-100/75 leading-relaxed font-sans font-light max-w-sm">
          ...
          <div className="space-y-4 flex flex-col items-center lg:items-start text-center lg:text-left">
            <h4 className="text-[#E9D5FF] font-extrabold uppercase tracking-widest text-[12px] font-mono">
              Marketplace
            </h4>
            <div className="w-8 h-[2px] bg-[#E9D5FF]/40 mx-auto lg:mx-0 rounded-full" />
              ...
              {[
                ...
                <li key={i}>
                  <button
                    ...
                    className="text-slate-100/70 hover:text-white hover:underline decoration-[#E9D5FF] decoration-2 underline-offset-4 transition-all text-xs font-sans font-medium cursor-pointer"
                  >
                    {link.name}
                  </button>
                </li>
              ...
              {[
                ...
                <li key={i}>
                  <button
                    ...
                    className="text-slate-100/70 hover:text-white hover:underline decoration-[#E9D5FF] decoration-2 underline-offset-4 transition-all text-xs font-sans font-medium cursor-pointer text-center lg:text-left"
                  >
                    {link.name}
                  </button>
                </li>
          ...
          <div className="space-y-5 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="space-y-1.5 w-full flex flex-col items-center lg:items-start">
              ...
              <div className="w-8 h-[2px] bg-[#E9D5FF]/40 mx-auto lg:mx-0 rounded-full" />
              <p className="text-[11px] text-slate-100/60 leading-normal font-sans pt-1 max-w-sm">
            ...
            <form onSubmit={handleSubscribe} className="space-y-3 w-full max-w-sm">
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 bg-slate-950/50 border border-sky-850 focus:border-[#E9D5FF] focus:ring-1 focus:ring-[#E9D5FF]/30 focus:outline-none rounded-xl text-xs text-white placeholder-slate-300/30 transition-all font-sans"
                />
                <Mail className="h-4 w-4 absolute left-3.5 top-3.5 text-slate-300/40" />
                <button
                  id="footer-subscribe-btn"
                  type="submit"
                  className="absolute right-1.5 top-1.5 p-2 bg-[#64748B] hover:bg-[#475569] text-white rounded-lg transition-all cursor-pointer flex items-center justify-center hover:shadow-[0_0_10px_rgba(0,180,216,0.3)] duration-300"
                >
                  {subscribed ? <Check className="h-3.5 w-3.5 text-white" /> : <Send className="h-3.5 w-3.5 text-white" />}
                </button>
              </div>
              {subscribed && (
                <p className="text-[11px] text-purple-400 font-bold font-sans flex items-center gap-1 justify-center lg:justify-start">
                  <span>✓ Verified. Sourcing alerts routed to mailbox!</span>
                </p>
              )}
            </form>

            <div className="flex items-center gap-2 text-[10.5px] leading-relaxed text-slate-200/50 pt-3 border-t border-slate-950 w-full justify-center lg:justify-start">
              <Phone className="h-3.5 w-3.5 text-[#E9D5FF]" strokeWidth={2.5} />
        ...
        <div className="pt-8 text-xs text-slate-200/40 font-mono flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-950/40 rounded-xl border border-slate-900/40">
      ...
      {supportMsg && (
        <div className="fixed inset-0 bg-[#020224]/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white text-slate-800 p-8 rounded-3xl max-w-md w-full relative border border-slate-100 shadow-2xl flex flex-col items-center">
            <div className="w-12 h-12 rounded-full bg-[#64748B]/10 mb-4 flex items-center justify-center text-[#64748B]">
              <Anchor className="h-6 w-6" />
            </div>
            <h4 className="font-serif text-xl font-bold text-[#64748B] mb-3 text-center">Sourcing Helpdesk Info</h4>
            ...
            <button
              ...
              className="w-full bg-[#64748B] hover:bg-[#64748B] text-white font-extrabold text-xs py-3 rounded-xl cursor-pointer transition-colors shadow-md hover:shadow-[#64748B]/10"
            >
