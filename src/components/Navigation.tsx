        ...
        <div id="nav-container" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-col justify-center font-sans">
              ...
              <span className={`text-[8px] sm:text-[9px] tracking-widest uppercase block font-bold ${
                isNavbarWhite ? 'text-green-700' : 'text-green-300'
              }`}>
                Sea to Kitchen
              </span>
            </div>
            ...
            <div className="flex items-center gap-1 bg-black/5 dark:bg-white/5 p-1 rounded-xl">
              <button
                ...
                className={`relative px-4 py-2 rounded-lg text-xs font-bold tracking-wider uppercase transition-colors cursor-pointer flex items-center gap-1.5 ${
                  currentPage === 'home'
                    ? isNavbarWhite ? 'text-white font-bold' : 'text-[#14532D] font-bold'
                    : isNavbarWhite ? 'text-gray-500 hover:text-[#14532D]' : 'text-green-100 hover:text-white'
                }`}
              >
                {currentPage === 'home' && (
                  <motion.div
                    ...
                    className={`absolute inset-0 rounded-lg -z-10 ${
                      isNavbarWhite ? 'bg-[#14532D]' : 'bg-white shadow-md'
                    }`}
          ...
          <div className="flex items-center gap-2 sm:gap-4">
              ...
              <AnimatePresence>
                {isSearchExpanded && (
                  <motion.input
                    ...
                    className={`h-9 px-3 text-xs rounded-lg border focus:outline-none focus:ring-1 focus:ring-green-500 mr-2 ${
                      isNavbarWhite ? 'bg-gray-50 border-gray-200 text-gray-800' : 'bg-white/15 border-white/20 text-white placeholder-green-200'
                    }`}
                  />
                )}
              </AnimatePresence>
            ...
            >
              ...
              {totalCartItems > 0 && (
                <span className="absolute -top-0.5 -right-0.5 bg-[#14532D] text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center font-bold">
                  {totalCartItems}
                </span>
              )}
            </button>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <motion.div
              ...
              className="w-4/5 max-w-sm h-full bg-[#14532D] text-white flex flex-col justify-between p-6 shadow-2xl relative"
            >
              <div>
                <div className="flex items-center justify-between mb-8 pb-4 border-b border-green-900/40">
                  ...
                  <button
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="p-1.5 rounded-lg bg-green-900/30 text-green-200 hover:text-white"
                  >
                    <X className="h-5 w-5" />
                  </button>
                </div>
                ...
                <nav className="flex flex-col gap-6 overflow-y-auto max-h-[60vh] pr-1">
                  ...
                  <div className="space-y-2">
                    <button
                      ...
                      className={`w-full text-left text-base font-bold pb-2 border-b border-green-900/40 flex items-center justify-between ${
                        currentPage === 'home' ? 'text-green-300' : 'text-green-200'
                      }`}
                    >
                  ...
                  <div className="space-y-2">
                    <button
                      ...
                      className={`w-full text-left text-base font-bold pb-2 border-b border-green-900/40 flex items-center justify-between ${
                        currentPage === 'market' ? 'text-green-300' : 'text-green-200'
                      }`}
                    >
              ...
              <div className="pb-8 pt-4 border-t border-green-900/40 flex flex-col gap-3">
                <button
                  id="mobile-auth-btn"
                  onClick={() => {
                    setIsMobileMenuOpen(false);
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#14532D] hover:bg-[#15803D] text-white font-semibold py-3 px-4 rounded-xl shadow-lg shadow-green-950/40 transition-colors text-sm"
                >
                  <User className="h-4 w-4" />
                  <span>{isLoggedIn ? 'Access Account' : 'Sign In Now'}</span>
                </button>
                <p className="text-center text-[10px] text-green-300/60 font-sans">
      ...
      <AnimatePresence>
        {isLoginModalOpen && (
          ...
          >
            ...
            >
              <div className="bg-[#14532D] p-6 text-white flex flex-col items-center relative">
                <button
                  id="login-close-btn"
                ...
                <p className="text-xs text-green-200 mt-1 text-center font-sans">Authentic coastal fresh seafood straight to your home</p>
              </div>
              ...
              <div className="p-6 sm:p-8">
                {isLoggedIn ? (
                  <div className="text-center py-4">
                    ...
                    <div className="p-3 bg-green-50 border border-green-100 rounded-xl mb-6 text-xs text-green-800 font-sans">
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500 bg-gray-50/50"
                      />
                    </div>
                    <div>
                      ...
                      <div className="flex gap-2">
                        ...
                        <input
                          ...
                          className="flex-1 px-3.5 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500 bg-gray-50/50"
                        />
                      </div>
                    </div>
                    ...
                    <div className="pt-2">
                      <button
                        id="submit-login-btn"
                        type="submit"
                        className="w-full bg-[#14532D] hover:bg-green-600 text-white font-bold text-sm py-3 rounded-xl transition-colors shadow-lg shadow-green-100 cursor-pointer"
                      >
