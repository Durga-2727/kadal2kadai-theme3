...
export default function TopSellingSection({
  ...
  return (
    <section id="top-selling" className="py-10 sm:py-12 bg-[#F8FAFC] border-t border-b border-slate-100 overflow-hidden relative">
      {/* Background Subtle Watermark Rings */}
      <div className="absolute inset-0 z-0 pointer-events-none opacity-[0.03]">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <circle cx="20%" cy="30%" r="200" fill="#115E59" />
          <circle cx="80%" cy="70%" r="300" fill="#0F4C48" />
        </svg>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#115E59]/10 border border-[#115E59]/20 rounded-full mb-3 text-[10px] sm:text-xs uppercase font-bold text-[#115E59] tracking-wider font-mono">
            <Award className="h-4.5 w-4.5 text-[#115E59]" />
          ...
          <div className="w-16 h-1 bg-[#115E59] mx-auto mt-4 rounded-full" />
        ...
        <div className="relative w-full overflow-hidden pause-marquee -mx-4 sm:mx-0">
          ...
          <div className="absolute top-0 bottom-0 left-0 w-8 sm:w-20 bg-gradient-to-r from-[#F8FAFC] to-transparent z-20 pointer-events-none" />
          <div className="absolute top-0 bottom-0 right-0 w-8 sm:w-20 bg-gradient-to-l from-[#F8FAFC] to-transparent z-20 pointer-events-none" />
                  ...
                  <div className="p-3 sm:p-4 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-1 mb-1">
                        <span className="text-[9px] sm:text-[10px] font-bold tracking-wider text-[#115E59] uppercase font-mono block max-w-[120px] truncate">
                          {p.localName}
                        </span>
                      ...
                      {/* Title block */}
                      <p className="font-serif text-sm sm:text-base font-bold text-slate-800 tracking-tight group-hover:text-[#115E59] transition-colors truncate">
                        {p.name}
                      </p>
                      ...
                      <div className="mt-3 flex items-center justify-between gap-1 group/select" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="relative">
                          <select
                            ...
                            className="bg-slate-50 border border-slate-100 text-[10px] font-bold text-slate-700 pr-5 pl-1.5 py-0.5 rounded-md appearance-none focus:outline-none cursor-pointer group-hover/select:border-[#115E59] transition-all"
                          >
                    ...
                    <div className="mt-4 pt-2.5 border-t border-slate-100 flex items-center justify-between">
                      <div className="flex flex-col">
                        <div className="flex items-baseline gap-0.5">
                          ...
                          <span className="text-base font-extrabold text-[#0F4C48]">{currentPrice}</span>
                        </div>
